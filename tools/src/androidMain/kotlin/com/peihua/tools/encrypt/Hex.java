package com.peihua.tools.encrypt;
...
public class Hex {
     ...
     * @throws Exception Thrown if an odd number of characters or illegal characters are supplied
     */
     ...
     * @throws Exception Thrown if an odd number of characters is supplied to this function
     * @see #decodeHex(char[])
     */
     ...
     * @return A byte array containing binary data decoded from the supplied byte array (representing characters).
     * @throws Exception Thrown if an odd number of characters is supplied to this function or the object is not
     *                          a String or char[]
     * @see #decodeHex(char[])
     */
